...
{    
    ...
    onSkeletonsAndMotionClipsLoaded(): void
    {
        ...
        this.balletDanceMotions[2].trimFront(480);
        this.balletDanceMotions[2].trimBack(300);

        this.balletDanceMotions[3].trimFront(480);
        this.balletDanceMotions[3].trimBack(100);

        this.balletDanceMotions[4].trimFront(220);
