...
export class AnimatedBone extends gfx.Node3
{
    ...
    applyPose(pose: Pose): void
    {
        ...
        const R = pose.getJointRotationMatrix(this.name);
        const all = gfx.Matrix4.multiplyAll(this.boneSpaceToParentBoneSpace, this.boneSpaceToJointSpace, R, this.jointSpaceToBoneSpace);
        this.setLocalToParentMatrix(all, false);
